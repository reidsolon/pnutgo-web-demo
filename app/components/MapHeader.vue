    ...
    <div class="relative z-10 px-4 py-3">
      <div class="flex items-center justify-between gap-3">
        ...
        <div class="flex-1 max-w-2xl">
          <div class="relative overflow-hidden bg-gradient-to-r from-amber-50 via-lime-50 to-emerald-50 rounded-3xl px-6 py-4">
        ...
        <div class="relative" ref="dropdownRef">
          ...
          >
            <div
              v-if="isDropdownOpen"
              class="absolute right-0 top-full mt-2 w-64 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden"
              style="z-index: 9999;"
            >
              <!-- User Info Section -->
